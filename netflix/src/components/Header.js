            ...
            <img className='w-56' src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Netflix_2015_logo.svg/1198px-Netflix_2015_logo.svg.png" alt="netflix-logo" />
            {
                user && (
                    <div className='flex items-center'>
                        ...
                        <div className='ml-4'>
                            <button onClick={logoutHandler} className='bg-red-600 hover:bg-red-700 text-white px-4 py-2'>Logout</button>
                            <button onClick={toggleHandler} className='bg-red-600 hover:bg-red-700 text-white px-4 py-2 ml-2'>{toggle ? "Home" : "Search Movie"}</button>
                        </div>
                    </div>
                )
            }
